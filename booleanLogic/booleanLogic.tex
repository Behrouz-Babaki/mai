...
\choice{not(A and B) is true whenever A is false or B is false}
...
\begin{multiple-choice}
\choice[correct]{By assigning value ``true'' to \emph{A} and
  ``false'' to \emph{B} and ``false'' to \emph{C}, the equation
evaluates to true.}
\choice{By assigning value ``false'' to \emph{A} and
  ``true'' to \emph{B} and ``false'' to \emph{C}, the equation
evaluates to true.}
\choice{By assigning value \answer{false} to \emph{A} and \answer{false} to
\emph{B} and \answer{true} to \emph{C}, the equation evaluates to
true.}
